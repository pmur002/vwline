expression(((((((1/(-1 - s2) * (1/(-1 - s2)) + 1/(-1 - s2) * 
    ...
    (((8 - 12 * (-s1) + t * (14 * (-s1) - 11 + t * (4 - 5 * (-s1)))) + 
        ...
        5 * (-s1)) + (4 - 5 * (-s1))))))))) * px2 + (((1/(1 + 
    s2) * (1/(1 + s2)) + 1/(1 + s2) * (1/(1 + s2))) * ((t - 1 + 
    s2)/(1 + s2)) + (1/(1 + s2) * ((t - 1 + s2)/(1 + s2)) + ((t - 
    1 + s2)/(1 + s2)) * (1/(1 + s2))) * (1/(1 + s2)) + (1/(1 + 
    s2) * ((t - 1 + s2)/(1 + s2)) + ((t - 1 + s2)/(1 + s2)) * 
    (1/(1 + s2))) * (1/(1 + s2))) * (10 - (2 * (1 + s2) * (1 + 
    ...
    ((6 - (2 * (1 + s2) * (1 + s2))) * (1/(1 + s2)) * (1/(1 + 
        s2)) + (6 - (2 * (1 + s2) * (1 + s2))) * (1/(1 + s2)) * 
        (1/(1 + s2))))) * px3)/((-t) * ((-s1) + (-t) * (2 * (-s1) + 
    (-t) * (-t) * (-2 * (-s1) - (-t) * (-s1)))) + ((t - 1 - s2)/(-1 - 
    s2)) * ((t - 1 - s2)/(-1 - s2)) * ((t - 1 - s2)/(-1 - s2)) * 
    ...
    s2)) + (2 * (2 * (1 + s2) * (1 + s2)) - 15) * ((t - 1 + s2)/(1 + 
    s2)) + (6 - (2 * (1 + s2) * (1 + s2))) * ((t - 1 + s2)/(1 + 
    s2)) * ((t - 1 + s2)/(1 + s2)))) - (((-t) * ((-t) * ((-t) * 
    (-t) * (-s1) - ((-t) + (-t)) * (-2 * (-s1) - (-t) * (-s1))) - 
    (2 * (-s1) + (-t) * (-t) * (-2 * (-s1) - (-t) * (-s1)))) - 
    ((-s1) + (-t) * (2 * (-s1) + (-t) * (-t) * (-2 * (-s1) - 
        (-t) * (-s1))))) * px0 + (((1/(-1 - s2) * ((t - 1 - s2)/(-1 - 
    s2)) + ((t - 1 - s2)/(-1 - s2)) * (1/(-1 - s2))) * ((t - 
    1 - s2)/(-1 - s2)) + ((t - 1 - s2)/(-1 - s2)) * ((t - 1 - 
    ...
    s2)) * ((t - 1 + s2)/(1 + s2))) + ((t - 1 + s2)/(1 + s2)) * 
    ((t - 1 + s2)/(1 + s2)) * ((t - 1 + s2)/(1 + s2)) * ((2 * 
    (2 * (1 + s2) * (1 + s2)) - 15) * (1/(1 + s2)) + ((6 - (2 * 
    (1 + s2) * (1 + s2))) * (1/(1 + s2)) * ((t - 1 + s2)/(1 + 
    s2)) + (6 - (2 * (1 + s2) * (1 + s2))) * ((t - 1 + s2)/(1 + 
    s2)) * (1/(1 + s2)))))) + ((-t) * ((-s1) + (-t) * (2 * (-s1) + 
    (-t) * (-t) * (-2 * (-s1) - (-t) * (-s1)))) * px0 + ((t - 
    1 - s2)/(-1 - s2)) * ((t - 1 - s2)/(-1 - s2)) * ((t - 1 - 
    ...
    (((1/(-1 - s2) * (1/(-1 - s2)) + 1/(-1 - s2) * (1/(-1 - s2))) * 
        ...
        (((1/(1 + s2) * ((t - 1 + s2)/(1 + s2)) + ((t - 1 + s2)/(1 + 
            ...
            1 + s2)/(1 + s2)) * ((t - 1 + s2)/(1 + s2)) * ((6 - 
            (2 * (1 + s2) * (1 + s2))) * (1/(1 + s2)) * (1/(1 + 
            s2)) + (6 - (2 * (1 + s2) * (1 + s2))) * (1/(1 + 
            s2)) * (1/(1 + s2)))))))/((-t) * ((-s1) + (-t) * 
    (2 * (-s1) + (-t) * (-t) * (-2 * (-s1) - (-t) * (-s1)))) + 
    ((t - 1 - s2)/(-1 - s2)) * ((t - 1 - s2)/(-1 - s2)) * ((t - 
    ...
    (1/(1 + s2)) * ((t - 1 + s2)/(1 + s2)) + (6 - (2 * (1 + s2) * 
    (1 + s2))) * ((t - 1 + s2)/(1 + s2)) * (1/(1 + s2))))) * 
    px3)/((-t) * ((-s1) + (-t) * (2 * (-s1) + (-t) * (-t) * (-2 * 
    (-s1) - (-t) * (-s1)))) + ((t - 1 - s2)/(-1 - s2)) * ((t - 
    1 - s2)/(-1 - s2)) * ((t - 1 - s2)/(-1 - s2)) * (10 - (2 * 
    ...
    s2)) + (2 * (2 * (1 + s2) * (1 + s2)) - 15) * ((t - 1 + s2)/(1 + 
    s2)) + (6 - (2 * (1 + s2) * (1 + s2))) * ((t - 1 + s2)/(1 + 
    s2)) * ((t - 1 + s2)/(1 + s2))))^2)^2 + ((((-t) * ((-t) * 
    ((-t) * (-t) * (-s1) - ((-t) + (-t)) * (-2 * (-s1) - (-t) * 
        (-s1))) - (2 * (-s1) + (-t) * (-t) * (-2 * (-s1) - (-t) * 
    (-s1)))) - ((-s1) + (-t) * (2 * (-s1) + (-t) * (-t) * (-2 * 
    (-s1) - (-t) * (-s1))))) * py0 + (((1/(-1 - s2) * ((t - 1 - 
    s2)/(-1 - s2)) + ((t - 1 - s2)/(-1 - s2)) * (1/(-1 - s2))) * 
    ((t - 1 - s2)/(-1 - s2)) + ((t - 1 - s2)/(-1 - s2)) * ((t - 
    1 - s2)/(-1 - s2)) * (1/(-1 - s2))) * (10 - (2 * (-1 - s2) * 
    (-1 - s2)) + (2 * (2 * (-1 - s2) * (-1 - s2)) - 15) * ((t - 
    ...
    (2 * (-1 - s2) * (-1 - s2))) * (1/(-1 - s2)) * ((t - 1 - 
    s2)/(-1 - s2)) + (6 - (2 * (-1 - s2) * (-1 - s2))) * ((t - 
    1 - s2)/(-1 - s2)) * (1/(-1 - s2))))) * py1 + (((-s1) + t * 
    (2 * (-s1) + t * (8 - 12 * (-s1) + t * (14 * (-s1) - 11 + 
        t * (4 - 5 * (-s1)))))) + t * ((2 * (-s1) + t * (8 - 
    12 * (-s1) + t * (14 * (-s1) - 11 + t * (4 - 5 * (-s1))))) + 
    t * ((8 - 12 * (-s1) + t * (14 * (-s1) - 11 + t * (4 - 5 * 
        (-s1)))) + t * ((14 * (-s1) - 11 + t * (4 - 5 * (-s1))) + 
        t * (4 - 5 * (-s1)))))) * py2 + (((1/(1 + s2) * ((t - 
    1 + s2)/(1 + s2)) + ((t - 1 + s2)/(1 + s2)) * (1/(1 + s2))) * 
    ((t - 1 + s2)/(1 + s2)) + ((t - 1 + s2)/(1 + s2)) * ((t - 
    1 + s2)/(1 + s2)) * (1/(1 + s2))) * (10 - (2 * (1 + s2) * 
    (1 + s2)) + (2 * (2 * (1 + s2) * (1 + s2)) - 15) * ((t - 
