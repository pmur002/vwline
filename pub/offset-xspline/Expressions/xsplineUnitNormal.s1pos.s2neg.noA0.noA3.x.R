expression(((((((1/(1 + s1) * (1/(1 + s1)) + 1/(1 + s1) * (1/(1 + 
    ...
    ((1 - t) * (4 - 5 * (-s2)) + (14 * (-s2) - 11 + (1 - t) * 
        (4 - 5 * (-s2)))) + (8 - 12 * (-s2) + (1 - t) * (14 * 
    (-s2) - 11 + (1 - t) * (4 - 5 * (-s2)))) + ((1 - t) * ((1 - 
    t) * (4 - 5 * (-s2)) + (14 * (-s2) - 11 + (1 - t) * (4 - 
    5 * (-s2))) + ((1 - t) * ((4 - 5 * (-s2)) + (4 - 5 * (-s2))) + 
    ((1 - t) * (4 - 5 * (-s2)) + (14 * (-s2) - 11 + (1 - t) * 
        (4 - 5 * (-s2)))))) + ((1 - t) * ((1 - t) * (4 - 5 * 
    ...
    px1 + ((2 * (-s2) + (t - 1) * (t - 1) * (-2 * (-s2) - (t - 
    1) * (-s2))) + (t - 1) * (((t - 1) + (t - 1)) * (-2 * (-s2) - 
    (t - 1) * (-s2)) - (t - 1) * (t - 1) * (-s2)) + (((2 * (-s2) + 
    ...
    11 + (1 - t) * (4 - 5 * (-s2))))))) + (((-s2) + (t - 1) * 
    (2 * (-s2) + (t - 1) * (t - 1) * (-2 * (-s2) - (t - 1) * 
        (-s2)))) + (t - 1) * ((2 * (-s2) + (t - 1) * (t - 1) * 
    (-2 * (-s2) - (t - 1) * (-s2))) + (t - 1) * (((t - 1) + (t - 
    1)) * (-2 * (-s2) - (t - 1) * (-s2)) - (t - 1) * (t - 1) * 
    (-s2)))))/(0 + (1 - t) * ((-s2) + (1 - t) * (2 * (-s2) + 
    (1 - t) * (8 - 12 * (-s2) + (1 - t) * (14 * (-s2) - 11 + 
        (1 - t) * (4 - 5 * (-s2)))))) + ((t + s1)/(1 + s1)) * 
    ...
    (-2 * (-s2) - (t - 1) * (-s2))) + (t - 1) * (((t - 1) + (t - 
    1)) * (-2 * (-s2) - (t - 1) * (-s2)) - (t - 1) * (t - 1) * 
    (-s2))))) + (0 * px0 + (1 - t) * ((-s2) + (1 - t) * (2 * 
    (-s2) + (1 - t) * (8 - 12 * (-s2) + (1 - t) * (14 * (-s2) - 
    11 + (1 - t) * (4 - 5 * (-s2)))))) * px1 + ((t + s1)/(1 + 
    s1)) * ((t + s1)/(1 + s1)) * ((t + s1)/(1 + s1)) * (10 - 
    (2 * (1 + s1) * (1 + s1)) + (2 * (2 * (1 + s1) * (1 + s1)) - 
    15) * ((t + s1)/(1 + s1)) + (6 - (2 * (1 + s1) * (1 + s1))) * 
    ((t + s1)/(1 + s1)) * ((t + s1)/(1 + s1))) * px2 + (t - 1) * 
    ((-s2) + (t - 1) * (2 * (-s2) + (t - 1) * (t - 1) * (-2 * 
        (-s2) - (t - 1) * (-s2)))) * px3) * (((1/(1 + s1) * (1/(1 + 
    ...
    ((1/(1 + s1) * ((t + s1)/(1 + s1)) + ((t + s1)/(1 + s1)) * 
        ...
        s1)) * ((t + s1)/(1 + s1)) * (1/(1 + s1))) * ((2 * (2 * 
        (1 + s1) * (1 + s1)) - 15) * (1/(1 + s1)) + ((6 - (2 * 
        (1 + s1) * (1 + s1))) * (1/(1 + s1)) * ((t + s1)/(1 + 
        s1)) + (6 - (2 * (1 + s1) * (1 + s1))) * ((t + s1)/(1 + 
        s1)) * (1/(1 + s1)))) + (((1/(1 + s1) * ((t + s1)/(1 + 
    s1)) + ((t + s1)/(1 + s1)) * (1/(1 + s1))) * ((t + s1)/(1 + 
    s1)) + ((t + s1)/(1 + s1)) * ((t + s1)/(1 + s1)) * (1/(1 + 
    ...
    s1)) + ((6 - (2 * (1 + s1) * (1 + s1))) * (1/(1 + s1)) * 
    ((t + s1)/(1 + s1)) + (6 - (2 * (1 + s1) * (1 + s1))) * ((t + 
    s1)/(1 + s1)) * (1/(1 + s1))))) * px2 - ((1 - t) * ((1 - 
    t) * ((1 - t) * ((1 - t) * (4 - 5 * (-s2)) + (14 * (-s2) - 
    11 + (1 - t) * (4 - 5 * (-s2)))) + (8 - 12 * (-s2) + (1 - 
    t) * (14 * (-s2) - 11 + (1 - t) * (4 - 5 * (-s2))))) + (2 * 
    (-s2) + (1 - t) * (8 - 12 * (-s2) + (1 - t) * (14 * (-s2) - 
    11 + (1 - t) * (4 - 5 * (-s2)))))) + ((-s2) + (1 - t) * (2 * 
    (-s2) + (1 - t) * (8 - 12 * (-s2) + (1 - t) * (14 * (-s2) - 
    11 + (1 - t) * (4 - 5 * (-s2))))))) * px1 + (((-s2) + (t - 
    1) * (2 * (-s2) + (t - 1) * (t - 1) * (-2 * (-s2) - (t - 
    1) * (-s2)))) + (t - 1) * ((2 * (-s2) + (t - 1) * (t - 1) * 
    (-2 * (-s2) - (t - 1) * (-s2))) + (t - 1) * (((t - 1) + (t - 
    1)) * (-2 * (-s2) - (t - 1) * (-s2)) - (t - 1) * (t - 1) * 
    (-s2)))) * px3)/(0 + (1 - t) * ((-s2) + (1 - t) * (2 * (-s2) + 
    (1 - t) * (8 - 12 * (-s2) + (1 - t) * (14 * (-s2) - 11 + 
        (1 - t) * (4 - 5 * (-s2)))))) + ((t + s1)/(1 + s1)) * 
    ((t + s1)/(1 + s1)) * ((t + s1)/(1 + s1)) * (10 - (2 * (1 + 
    s1) * (1 + s1)) + (2 * (2 * (1 + s1) * (1 + s1)) - 15) * 
    ...
    (-2 * (-s2) - (t - 1) * (-s2))) + (t - 1) * (((t - 1) + (t - 
    1)) * (-2 * (-s2) - (t - 1) * (-s2)) - (t - 1) * (t - 1) * 
    (-s2))))) + (0 * py0 + (1 - t) * ((-s2) + (1 - t) * (2 * 
    (-s2) + (1 - t) * (8 - 12 * (-s2) + (1 - t) * (14 * (-s2) - 
    11 + (1 - t) * (4 - 5 * (-s2)))))) * py1 + ((t + s1)/(1 + 
    s1)) * ((t + s1)/(1 + s1)) * ((t + s1)/(1 + s1)) * (10 - 
    (2 * (1 + s1) * (1 + s1)) + (2 * (2 * (1 + s1) * (1 + s1)) - 
    15) * ((t + s1)/(1 + s1)) + (6 - (2 * (1 + s1) * (1 + s1))) * 
    ((t + s1)/(1 + s1)) * ((t + s1)/(1 + s1))) * py2 + (t - 1) * 
    ((-s2) + (t - 1) * (2 * (-s2) + (t - 1) * (t - 1) * (-2 * 
        (-s2) - (t - 1) * (-s2)))) * py3) * (((1/(1 + s1) * (1/(1 + 
    s1)) + 1/(1 + s1) * (1/(1 + s1))) * ((t + s1)/(1 + s1)) + 
    (1/(1 + s1) * ((t + s1)/(1 + s1)) + ((t + s1)/(1 + s1)) * 
        (1/(1 + s1))) * (1/(1 + s1)) + (1/(1 + s1) * ((t + s1)/(1 + 
    s1)) + ((t + s1)/(1 + s1)) * (1/(1 + s1))) * (1/(1 + s1))) * 
    ...
    (10 - (2 * (1 + s1) * (1 + s1)) + (2 * (2 * (1 + s1) * (1 + 
        ...
        (1 + s1))) * ((t + s1)/(1 + s1)) * ((t + s1)/(1 + s1))) + 
    (t - 1) * ((-s2) + (t - 1) * (2 * (-s2) + (t - 1) * (t - 
        1) * (-2 * (-s2) - (t - 1) * (-s2)))))^2 - (0 * py0 + 
    (1 - t) * ((-s2) + (1 - t) * (2 * (-s2) + (1 - t) * (8 - 
        12 * (-s2) + (1 - t) * (14 * (-s2) - 11 + (1 - t) * (4 - 
        5 * (-s2)))))) * py1 + ((t + s1)/(1 + s1)) * ((t + s1)/(1 + 
    s1)) * ((t + s1)/(1 + s1)) * (10 - (2 * (1 + s1) * (1 + s1)) + 
    (2 * (2 * (1 + s1) * (1 + s1)) - 15) * ((t + s1)/(1 + s1)) + 
    (6 - (2 * (1 + s1) * (1 + s1))) * ((t + s1)/(1 + s1)) * ((t + 
        s1)/(1 + s1))) * py2 + (t - 1) * ((-s2) + (t - 1) * (2 * 
    (-s2) + (t - 1) * (t - 1) * (-2 * (-s2) - (t - 1) * (-s2)))) * 
    py3) * (((1/(1 + s1) * ((t + s1)/(1 + s1)) + ((t + s1)/(1 + 
    s1)) * (1/(1 + s1))) * ((t + s1)/(1 + s1)) + ((t + s1)/(1 + 
    s1)) * ((t + s1)/(1 + s1)) * (1/(1 + s1))) * (10 - (2 * (1 + 
    s1) * (1 + s1)) + (2 * (2 * (1 + s1) * (1 + s1)) - 15) * 
    ((t + s1)/(1 + s1)) + (6 - (2 * (1 + s1) * (1 + s1))) * ((t + 
    ...
    11 + (1 - t) * (4 - 5 * (-s2)))))) + ((-s2) + (1 - t) * (2 * 
    (-s2) + (1 - t) * (8 - 12 * (-s2) + (1 - t) * (14 * (-s2) - 
    11 + (1 - t) * (4 - 5 * (-s2))))))) * py1 + (((-s2) + (t - 
    1) * (2 * (-s2) + (t - 1) * (t - 1) * (-2 * (-s2) - (t - 
    1) * (-s2)))) + (t - 1) * ((2 * (-s2) + (t - 1) * (t - 1) * 
    (-2 * (-s2) - (t - 1) * (-s2))) + (t - 1) * (((t - 1) + (t - 
    1)) * (-2 * (-s2) - (t - 1) * (-s2)) - (t - 1) * (t - 1) * 
    (-s2)))) * py3)/(0 + (1 - t) * ((-s2) + (1 - t) * (2 * (-s2) + 
    (1 - t) * (8 - 12 * (-s2) + (1 - t) * (14 * (-s2) - 11 + 
        (1 - t) * (4 - 5 * (-s2)))))) + ((t + s1)/(1 + s1)) * 
    ((t + s1)/(1 + s1)) * ((t + s1)/(1 + s1)) * (10 - (2 * (1 + 
    s1) * (1 + s1)) + (2 * (2 * (1 + s1) * (1 + s1)) - 15) * 
